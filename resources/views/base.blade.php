	...
	<div id="home" class="header">
		...
		<div class="header-bottom">
			<!-- container -->
				...
				<div class="head-logo">
					<a href="index.html"><img src="images/logo.png" class="img-responsive" alt="dtg" /></a>
				</div>
							...
							<div class="banner-top">
								<span class="menu">MENU</span>
									<ul class="nav banner-nav">
										<li class="dropdown1"><a href="">Business</a></li>
										<li class="dropdown1"><a href="">Reviews</a>
											<ul class="dropdown2">
										...
										<li class="dropdown1"><a href="">Random</a></li>
								</ul>
								<script>
							...
							<div class="banner-middle">
								...
								<div class="banner-bottom-grids">
									...
									<div class="col-md-8 banner-bottom-left">
										<div class="banner-bottom-left-grids">
											<div class="banner-left-grid lifestyle-left-grid">
												<a href="single.html"><img src="images/pp1.jpg" alt="" /></a>
											...
											<div class="banner-left-grid lifestyle-left-grid">
												<a href="single.html"><img src="images/pp3.jpg" alt="" /></a>
												<h4><a href="single.html">Silicon Valley Shows Signs of Dot-Com Frenzy Quisque eu luctus ex. Pellentesque ullamcorper ac enim vel tincidunt</a></h4>
												<p class="comments">August 4 2010, <a href="#">8 Comments</a></p>
												<p class="text">Lorem ipsum ex vix illud nonummy, novum tation et his. At vix scripta patrioque scribentur
												Maecenas viverra rhoncus sem, nec laoreet sem. Aliquam convallis, nulla ac vehicula efficitur, quam turpis lacinia dolor, iaculis efficitur lacus turpis vitae est. Duis tristique facilisis posuere
										...
										<div class="post">
											...
											<div class="post-grids">
												<div class="col-md-4 post-left">
													<a href="single.html"><img src="images/pic7.jpg" alt="" /></a>
												</div>
											...
											<div class="post-grids">
												<div class="col-md-4 post-left">
													<a href="single.html"><img src="images/pic8.jpg" alt="" /></a>
												</div>
												<div class="col-md-8 post-right">
									...
									<div class="col-md-4 banner-bottom-right">
										...
										<div class="lor-ip">
											<div class="lor-ip">
												<div class="fb-page" data-href="https://www.facebook.com/creativejunkiez" data-hide-cover="true" data-show-facepile="true" data-show-posts="false">
													<div class="fb-xfbml-parse-ignore">
														<blockquote cite="https://www.facebook.com/facebook">
															<a href="https://www.facebook.com/creativejunkiez">Facebook</a>
														</blockquote>
													</div>
												</div>
												<div id="fb-root"></div>
	...
	<div class="footer">
		<!-- container -->
			<div class="footer-grids">
				...
				<div class="clearfix"> </div>
				<div class="copyright">
					<p>Copyrights © 2015 <?= $app_name ?> All rights reserved </p>
				</div>
			</div>
	</div>
	</div>
